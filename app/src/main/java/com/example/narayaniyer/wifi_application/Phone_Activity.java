        ...
        callBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    if (ActivityCompat.checkSelfPermission(Phone_Activity.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
        ...
        public void onCallStateChanged(int state,String incomingno)
        {
            switch(state)
            {
                case TelephonyManager.CALL_STATE_RINGING:
                    //Phone Ringing
                    Toast.makeText(Phone_Activity.this, incomingno+"Calls you",Toast.LENGTH_LONG).show();
                    break;

                case TelephonyManager.CALL_STATE_OFFHOOK:
                    //one call exists thats dialing,active or on hold
                    Toast.makeText(Phone_Activity.this,"on call...", Toast.LENGTH_LONG).show();
                ...
                case TelephonyManager.CALL_STATE_IDLE:
                    ...
                    if(onCall==true)
                    {
                        Toast.makeText(Phone_Activity.this,"restart app after call...",Toast.LENGTH_LONG).show();
